...
% Function to generate a cellExplorer session struct for
% Confidence/Optotagging Recordings - Assumes a certain folder structure
% that is read and processed with parseRecordingPath(filePath) function
